...
class SMSView(APIView):
    ...
    def send_sms (self, phone, msg) :#, ref, phone):
        ...
        headers = {
          'token':'SMS eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2FwaWtleSI6IjYyYjk2NTFjYWJmMTI4ZTA0ZWI1ODhkYmY1YzllYzg5NmJmYTc1NmIiLCJ1c2VyX2VtYWlsIjoib2RyYXVkZWs5OUBnbWFpbC5jb20iLCJ1c2VyX2lkIjozMjg1MiwiaWF0IjoxNTY2NjkzMTQ4fQ.QmAlECu6Gxi3_rM3buVDvihptCk4gMIhS4hZsue1-X4'
        }
        data = {
          'message':msg,
          'numbers':phone,
